...
const bushARMTexture = textureLoader.load('./bush/lleaves_forest_ground_arm_1k.jpg')
...
const floor = new THREE.Mesh(
    new THREE.PlaneGeometry(20,20, 100, 100), new THREE.MeshStandardMaterial({
        alphaMap: floorAlphaTexture, transparent: true, map: floorColorTexture,
        aoMap: floorARMTexture, roughnessMap: floorARMTexture, metalnessMap: floorARMTexture,
        normalMap: floorNormalTexture, displacementMap: floorDisplacementTexture, displacementScale: .3,
...
const walls = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial( {map: wallColorTexture,
...
for(let i = 0; i < 30; i++)
{
    ...
    const radius = 3 + Math.random() * 4 //randowm radius bewteen 3 and 7
